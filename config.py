...
class Config:
    ...
    def sync_paths(self) -> None:
        ...
        self.interest_states_path = self.output_dir / self.tagged_filename(
            f"interest_states_{self.interest_discovery_cache_tag}",
            ".pkl",
        )
    ...
    @property
    def interest_discovery_cache_tag(self) -> str:
        payload = {
